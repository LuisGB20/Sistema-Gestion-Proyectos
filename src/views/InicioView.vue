...
<template>
    <main class="py-4 flex flex-col gap-[2rem]">
        ...
        <div class="w-full mt-[8rem] mb-[3rem] py-3 flex flex-col items-center justify-center">
            ...
            <div class="text-[#124E66] font-bold capitalize w-4/6 flex flex-row py-6 justify-between">
        ...
        <div class="p-3 sm:px-[6rem] w-full flex sm:flex-row flex-col justify-center flex-wrap">
            <div class="w-full sm:w-1/2 px-2 flex flex-col">
                <div class="w-full flex flex-col sm:flex-row sm:px-4 gap-2 sm:gap-0">
                    <div class="bg-white w-full p-6 rounded-lg shadow-xl">
        ...
        <div class="w-full bg-[#2E3944] my-[4rem] py-[2rem] flex flex-col items-center justify-center">
            <div class="w-full text-center p-2">
                <h1 class="text-[#D3D9D4] text-3xl font-bold uppercase">Nuestro objetivo es impulsar el crecimiento de los proyectos</h1>
            </div>
